...
// For when followers/following want to request your profile update back to their server
exports.getIncoming = function(req, reply) {
  let data = req.query;

  db.get('profile', function(err, account) {
    if (account) {
      console.log('getting your account for follower/following request ', account);
      request({
